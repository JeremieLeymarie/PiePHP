...
<div class="genre-container">
    <section>
        <ul>
            ...
            <li><a href="http://localhost/pie/genre/<?= htmlentities($value['id_genre'])?>"><?= htmlentities(ucfirst($value["nom"]))?></a></li>
            <?php endforeach;?>
        </ul>
    </section>
    <?php if(isset($genre)):?>
    <section>
        ...
        <a class="btn" href="http://localhost/pie/deleteGenre/<?= htmlentities($genre['id_genre'])?>">
            Supprimer le genre
        </a>
    </section>
    <?php endif;?>
